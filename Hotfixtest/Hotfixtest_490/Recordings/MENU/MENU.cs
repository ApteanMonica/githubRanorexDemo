...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    ///The MENU recording.
    /// </summary>
    [TestModule("bc5b836c-ffde-43b3-8717-18279c60a694", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 1m to exist. Associated repository item: 'FormWorkplace.Bestellung'", repo.FormWorkplace.BestellungInfo, new ActionTimeout(60000), new RecordItemIndex(5));
            repo.FormWorkplace.BestellungInfo.WaitForExists(60000);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'FormWorkplace.Bestellung'.", repo.FormWorkplace.BestellungInfo, new RecordItemIndex(6));
            Validate.Exists(repo.FormWorkplace.BestellungInfo);
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 1m to exist. Associated repository item: 'FormWorkplace1.DockContainerWorkplace.DfKtoNr'", repo.FormWorkplace1.DockContainerWorkplace.DfKtoNrInfo, new ActionTimeout(60000), new RecordItemIndex(11));
            repo.FormWorkplace1.DockContainerWorkplace.DfKtoNrInfo.WaitForExists(60000);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'FormWorkplace1.DockContainerWorkplace.DfKtoNr'.", repo.FormWorkplace1.DockContainerWorkplace.DfKtoNrInfo, new RecordItemIndex(12));
            Validate.Exists(repo.FormWorkplace1.DockContainerWorkplace.DfKtoNrInfo);
