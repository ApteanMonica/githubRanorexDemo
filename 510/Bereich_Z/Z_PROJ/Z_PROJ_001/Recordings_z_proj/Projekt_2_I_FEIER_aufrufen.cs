...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Projekt_2_I_FEIER_aufrufen recording.
    /// </summary>
    [TestModule("dce33771-6244-40f1-af8e-05a18beca3a8", ModuleType.Recording, 1)]
    public partial class Projekt_2_I_FEIER_aufrufen : ITestModule
    {
        /// <summary>
        ...
        static Projekt_2_I_FEIER_aufrufen instance = new Projekt_2_I_FEIER_aufrufen();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Projekt_2_I_FEIER_aufrufen()
        {
        ...
        /// </summary>
        public static Projekt_2_I_FEIER_aufrufen Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("80655356-727f-456c-aea7-5d364e0dee81")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$PROJ_NR_2_IP' with focus on 'FrmTabProjekt_alt.Text_Suchmaske'.", repo.FrmTabProjekt_alt.Text_SuchmaskeInfo, new RecordItemIndex(1));
            repo.FrmTabProjekt_alt.Text_Suchmaske.PressKeys(PROJ_NR_2_IP);
