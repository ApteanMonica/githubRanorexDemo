...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$PROJ_NR_2_IP' with focus on 'FrmTabProjekt.Text_Suchmaske'.", repo.FrmTabProjekt.Text_SuchmaskeInfo, new RecordItemIndex(1));
            repo.FrmTabProjekt.Text_Suchmaske.PressKeys(PROJ_NR_2_IP);
