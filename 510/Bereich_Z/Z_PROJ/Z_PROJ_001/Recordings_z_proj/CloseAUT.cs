...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("8aa82bb8-1703-4104-8e3c-8de34f239a0f", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmTabProjekt'.", repo.FrmTabProjekt.SelfInfo, new RecordItemIndex(1));
            Host.Current.CloseApplication(repo.FrmTabProjekt.Self, 1000);
