...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Projekt_I_FORUM_aufrufen recording.
    /// </summary>
    [TestModule("575d486a-1e10-48e1-8a58-1c260b1d1d0a", ModuleType.Recording, 1)]
    public partial class Projekt_I_FORUM_aufrufen : ITestModule
    {
        /// <summary>
        ...
        static Projekt_I_FORUM_aufrufen instance = new Projekt_I_FORUM_aufrufen();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Projekt_I_FORUM_aufrufen()
        {
        ...
        /// </summary>
        public static Projekt_I_FORUM_aufrufen Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("e7d5c327-a77a-4411-9c87-3fffac62857c")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$PROJ_NR_I_FORUM_IP' with focus on 'FrmTabProjekt.Suche.Text'.", repo.FrmTabProjekt.Suche.TextInfo, new RecordItemIndex(1));
            repo.FrmTabProjekt.Suche.Text.PressKeys(PROJ_NR_I_FORUM_IP);
