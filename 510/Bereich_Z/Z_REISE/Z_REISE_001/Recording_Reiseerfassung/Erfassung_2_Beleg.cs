...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Erfassung_2_Beleg recording.
    /// </summary>
    [TestModule("47562a50-92f8-4a58-a2cd-b15b8f4b3fce", ModuleType.Recording, 1)]
    public partial class Erfassung_2_Beleg : ITestModule
    {
        /// <summary>
        ...
        static Erfassung_2_Beleg instance = new Erfassung_2_Beleg();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Erfassung_2_Beleg()
        {
        }
        ...
        /// </summary>
        public static Erfassung_2_Beleg Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'B2{Tab}' with focus on 'FormRk.TpBelege.DfRbelNummer'.", repo.FormRk.TpBelege.DfRbelNummerInfo, new RecordItemIndex(7));
            repo.FormRk.TpBelege.DfRbelNummer.PressKeys("B2{Tab}");
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '50{Tab}' with focus on 'FormRk.TpBelege.DfRbelFremdbrutto'.", repo.FormRk.TpBelege.DfRbelFremdbruttoInfo, new RecordItemIndex(10));
            repo.FormRk.TpBelege.DfRbelFremdbrutto.PressKeys("50{Tab}");
