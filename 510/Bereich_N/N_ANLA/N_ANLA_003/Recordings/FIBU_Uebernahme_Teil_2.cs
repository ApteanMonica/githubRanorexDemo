...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Konto_Anlagen_Nr' with focus on 'DlgFibu.DfKtoNr'.", repo.DlgFibu.DfKtoNrInfo, new RecordItemIndex(3));
            repo.DlgFibu.DfKtoNr.PressKeys(Konto_Anlagen_Nr);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DlgFibu.Row_mit_Belegnr' at Center.", repo.DlgFibu.Row_mit_BelegnrInfo, new RecordItemIndex(6));
            repo.DlgFibu.Row_mit_Belegnr.Click();
