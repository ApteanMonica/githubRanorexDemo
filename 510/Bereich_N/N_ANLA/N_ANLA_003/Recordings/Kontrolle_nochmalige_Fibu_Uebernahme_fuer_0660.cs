...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating NotExists on item 'DlgFibu.Row_Belegnummer_01'.", repo.DlgFibu.Row_Belegnummer_01Info, new RecordItemIndex(7));
            Validate.NotExists(repo.DlgFibu.Row_Belegnummer_01Info);
