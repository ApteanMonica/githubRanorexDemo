...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Stkl_mit_Stkl' with focus on 'FrmAufk.TpPos1.Tab_AufP.ArtNr'.", repo.FrmAufk.TpPos1.Tab_AufP.ArtNrInfo, new RecordItemIndex(1));
            repo.FrmAufk.TpPos1.Tab_AufP.ArtNr.PressKeys(Stkl_mit_Stkl);
