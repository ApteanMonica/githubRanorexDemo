...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1' at Center.", repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1Info, new RecordItemIndex(0));
            //repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1.Click();
            
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left DoubleClick item 'TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1' at Center.", repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1Info, new RecordItemIndex(1));
            //repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1.DoubleClick();
            ...
            //Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2' at Center.", repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2Info, new RecordItemIndex(3));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2' at Center.", repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2Info, new RecordItemIndex(5));
            repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2.Click();
            
            Tagesdatum = Ranorex.AutomationHelpers.UserCodeCollections.SystemLibrary.GetDateTimeAsString("dd.MM.yyyy");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Tagesdatum' with focus on 'TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2'.", repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow2Info, new RecordItemIndex(7));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1' at Center.", repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1Info, new RecordItemIndex(10));
            repo.TblFadr.tblRechArt_Pfad_verkuerzt.ColLskDatumRow1.Click();
