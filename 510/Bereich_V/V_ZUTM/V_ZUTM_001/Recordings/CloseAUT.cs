...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("e5e0229a-b6f6-4778-9ea9-db128e66f96e", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TblZutm.TitleBar100ManuelleZuteilung'.", repo.TblZutm.TitleBar100ManuelleZuteilungInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TblZutm.TitleBar100ManuelleZuteilung, 1000);
