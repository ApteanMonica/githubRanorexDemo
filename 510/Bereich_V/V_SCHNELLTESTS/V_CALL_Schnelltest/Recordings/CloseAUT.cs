...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("5a49a1ca-997a-457b-b9fb-6878d25e2da3", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmCallAuftrag.TitleBar100CallAuftrag'.", repo.FrmCallAuftrag.TitleBar100CallAuftragInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.FrmCallAuftrag.TitleBar100CallAuftrag, 1000);
