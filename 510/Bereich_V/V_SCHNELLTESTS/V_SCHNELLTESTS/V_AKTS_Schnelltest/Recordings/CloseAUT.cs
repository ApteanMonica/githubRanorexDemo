...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("d4fe9f82-b28a-4a67-970e-e3cdc5b6499f", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmMain.TitleBar100SerienaktivitaetenVerwal'.", repo.FrmMain.TitleBar100SerienaktivitaetenVerwalInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.FrmMain.TitleBar100SerienaktivitaetenVerwal, 1000);
