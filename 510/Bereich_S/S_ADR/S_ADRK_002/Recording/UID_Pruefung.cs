...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "User", newText, new RecordItemIndex(9));
            
            Ranorex.AutomationHelpers.UserCodeCollections.Aptean.ValidateTextWithoutBreaks(newText, Aptean_Austria);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DlgMessageBox.OK' at Center.", repo.DlgMessageBox.OKInfo, new RecordItemIndex(11));
            repo.DlgMessageBox.OK.Click();
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$UID_falsch' with focus on 'FrmAdr.TpAllgemein.UID_Nr'.", repo.FrmAdr.TpAllgemein.UID_NrInfo, new RecordItemIndex(13));
            repo.FrmAdr.TpAllgemein.UID_Nr.PressKeys(UID_falsch);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Tab}' with focus on 'FrmAdr.TpAllgemein.UID_Nr'.", repo.FrmAdr.TpAllgemein.UID_NrInfo, new RecordItemIndex(14));
            repo.FrmAdr.TpAllgemein.UID_Nr.PressKeys("{Tab}");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$UID_nicht_gueltig) on item 'DlgMessageBox.Fehlermeldung_UID_Nicht_gueltig'.", repo.DlgMessageBox.Fehlermeldung_UID_Nicht_gueltigInfo, new RecordItemIndex(15));
            Validate.AttributeContains(repo.DlgMessageBox.Fehlermeldung_UID_Nicht_gueltigInfo, "Text", UID_nicht_gueltig);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'DlgMessageBox.OK' at Center.", repo.DlgMessageBox.OKInfo, new RecordItemIndex(16));
            repo.DlgMessageBox.OK.Click();
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FrmAdr.Speicher_Button' at Center.", repo.FrmAdr.Speicher_ButtonInfo, new RecordItemIndex(17));
            repo.FrmAdr.Speicher_Button.Click();
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FrmAdr.Extras' at Center.", repo.FrmAdr.ExtrasInfo, new RecordItemIndex(18));
            repo.FrmAdr.Extras.Click();
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'SADR.UIDPruefung' at Center.", repo.SADR.UIDPruefungInfo, new RecordItemIndex(19));
            repo.SADR.UIDPruefung.Click();
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'Bearbeiten' at Center.", repo.BearbeitenInfo, new RecordItemIndex(20));
            repo.Bearbeiten.Click();
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblUidCheck.DfAdrNrVon' at Center.", repo.TblUidCheck.DfAdrNrVonInfo, new RecordItemIndex(21));
            repo.TblUidCheck.DfAdrNrVon.Click();
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Neue_Kundennummer' with focus on 'TblUidCheck.DfAdrNrVon'.", repo.TblUidCheck.DfAdrNrVonInfo, new RecordItemIndex(22));
            repo.TblUidCheck.DfAdrNrVon.PressKeys(Neue_Kundennummer);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblUidCheck.Laden' at Center.", repo.TblUidCheck.LadenInfo, new RecordItemIndex(23));
            repo.TblUidCheck.Laden.Click();
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='ATU75818635') on item 'TblUidCheck.ColAdrUidnrRow1'.", repo.TblUidCheck.ColAdrUidnrRow1Info, new RecordItemIndex(24));
            Validate.AttributeEqual(repo.TblUidCheck.ColAdrUidnrRow1Info, "Text", "ATU75818635");
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblUidCheck.Schliessen' at Center.", repo.TblUidCheck.SchliessenInfo, new RecordItemIndex(25));
            repo.TblUidCheck.Schliessen.Click();
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left DoubleClick item 'FrmAdr.TpAllgemein.UID_Nr' at Center.", repo.FrmAdr.TpAllgemein.UID_NrInfo, new RecordItemIndex(26));
            repo.FrmAdr.TpAllgemein.UID_Nr.DoubleClick();
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$UID_korrekt' with focus on 'FrmAdr.TpAllgemein.UID_Nr'.", repo.FrmAdr.TpAllgemein.UID_NrInfo, new RecordItemIndex(27));
            repo.FrmAdr.TpAllgemein.UID_Nr.PressKeys(UID_korrekt);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Tab}' with focus on 'FrmAdr.TpAllgemein.UID_Nr'.", repo.FrmAdr.TpAllgemein.UID_NrInfo, new RecordItemIndex(28));
            repo.FrmAdr.TpAllgemein.UID_Nr.PressKeys("{Tab}");
            
            //Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Aptean_Austria) on item 'DlgMessageBox.LabelMeldungstext'.", repo.DlgMessageBox.LabelMeldungstextInfo, new RecordItemIndex(29));
