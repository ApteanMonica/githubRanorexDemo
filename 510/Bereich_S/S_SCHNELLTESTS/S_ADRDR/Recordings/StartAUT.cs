...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Run application with file name from variable $Startfile in normal mode.", new RecordItemIndex(0));
            Host.Local.RunApplication(Startfile, "", "", false);
