...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblAda.FlexGrid.Row0Column0' at Center.", repo.TblAda.FlexGrid.Row0Column0Info, new RecordItemIndex(0));
            repo.TblAda.FlexGrid.Row0Column0.Click();
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$ADRESSART_NEU_BEZEICHNUNG'.", new RecordItemIndex(5));
