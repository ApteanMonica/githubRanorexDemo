...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Rechnung2) on item 'MdiEInfo1.Row_mit_Variable_Rechnung2.ColRechNr_Variable'.", repo.MdiEInfo1.Row_mit_Variable_Rechnung2.ColRechNr_VariableInfo, new RecordItemIndex(30));
            Validate.AttributeEqual(repo.MdiEInfo1.Row_mit_Variable_Rechnung2.ColRechNr_VariableInfo, "Text", Rechnung2);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='R') on item 'MdiEInfo1.Row_mit_Variable_Rechnung2.Copy_of_ColRechStatus_Variable'.", repo.MdiEInfo1.Row_mit_Variable_Rechnung2.Copy_of_ColRechStatus_VariableInfo, new RecordItemIndex(31));
            Validate.AttributeEqual(repo.MdiEInfo1.Row_mit_Variable_Rechnung2.Copy_of_ColRechStatus_VariableInfo, "Text", "R");
