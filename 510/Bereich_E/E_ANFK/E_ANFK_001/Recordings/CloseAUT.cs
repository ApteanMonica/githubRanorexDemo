...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("ef10405c-d422-402b-913a-204d9297e229", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TitleBar100Anfrageverwaltung'.", repo.TitleBar100AnfrageverwaltungInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TitleBar100Anfrageverwaltung, 1000);
