...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("7f53d9ed-39cd-4e55-a6a5-deed0e9e2235", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TitleBar100BestellungenBestaetigen'.", repo.TitleBar100BestellungenBestaetigenInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TitleBar100BestellungenBestaetigen, 1000);
