...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("df7c4989-a43c-4bc7-b5e5-bcf39206f894", ModuleType.Recording, 1)]
...
#region Variables
        ...
        /// </summary>
        [TestVariable("95f0bce2-1611-44fe-a9f7-57372c8f53a3")]
        public string Firma
        {
            get { return _Firma; }
            set { _Firma = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'E_LIST.Firmenwechsel' at Center.", repo.E_LIST.FirmenwechselInfo, new RecordItemIndex(0));
            repo.E_LIST.Firmenwechsel.Click();
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeRegex (AccessibleValue~$Firma) on item 'E_LIST.Titel_E_LIST'.", repo.E_LIST.Titel_E_LISTInfo, new RecordItemIndex(5));
            Validate.AttributeRegex(repo.E_LIST.Titel_E_LISTInfo, "AccessibleValue", new Regex(Firma));
