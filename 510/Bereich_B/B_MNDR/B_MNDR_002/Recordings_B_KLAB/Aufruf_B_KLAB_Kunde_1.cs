...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Aufruf_B_KLAB_Kunde_1 recording.
    /// </summary>
    [TestModule("4761f90b-cf18-4482-a634-6861bfdbbb4d", ModuleType.Recording, 1)]
    public partial class Aufruf_B_KLAB_Kunde_1 : ITestModule
    {
        /// <summary>
        ...
        static Aufruf_B_KLAB_Kunde_1 instance = new Aufruf_B_KLAB_Kunde_1();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Aufruf_B_KLAB_Kunde_1()
        {
            Kunde_1 = "200024";
        }
        ...
        /// </summary>
        public static Aufruf_B_KLAB_Kunde_1 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("dae89a7f-e093-478e-b6a4-a272a98e5bdb")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Kunde_1' with focus on 'FrmKlAb.FrmSearchPage.Text'.", repo.FrmKlAb.FrmSearchPage.TextInfo, new RecordItemIndex(0));
            repo.FrmKlAb.FrmSearchPage.Text.PressKeys(Kunde_1);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Kunde_1) on item 'FrmKlAb.Konto'.", repo.FrmKlAb.KontoInfo, new RecordItemIndex(2));
            Validate.AttributeEqual(repo.FrmKlAb.KontoInfo, "Text", Kunde_1);
