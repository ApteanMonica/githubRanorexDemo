...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("86858321-cbff-4671-8e6d-e11c71270e82", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TblMndt.TitleBar100MahnenKunden'.", repo.TblMndt.TitleBar100MahnenKundenInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TblMndt.TitleBar100MahnenKunden, 1000);
