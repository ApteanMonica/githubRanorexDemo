...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'B_BUAB_TblB.PbDataAccessLoad' at Center.", repo.B_BUAB_TblB.PbDataAccessLoadInfo, new RecordItemIndex(0));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColKeyposRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColKeyposRow2Info, new RecordItemIndex(14));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColKeyposRow2Info, "Text", "2");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='4000') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColKtoNrRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColKtoNrRow2Info, new RecordItemIndex(15));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColKtoNrRow2Info, "Text", "4000");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='S') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColArtRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColArtRow2Info, new RecordItemIndex(16));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColArtRow2Info, "Text", "S");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2000') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColGKtoNrRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColGKtoNrRow2Info, new RecordItemIndex(17));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColGKtoNrRow2Info, "Text", "2000");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='83,33') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColBetragRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColBetragRow2Info, new RecordItemIndex(18));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColBetragRow2Info, "Text", "83,33");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='H') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColSHRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColSHRow2Info, new RecordItemIndex(19));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColSHRow2Info, "Text", "H");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='M20') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColUstcdRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColUstcdRow2Info, new RecordItemIndex(20));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColUstcdRow2Info, "Text", "M20");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='16,67') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColUstbetragRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColUstbetragRow2Info, new RecordItemIndex(21));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColUstbetragRow2Info, "Text", "16,67");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2020-1') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColUvaRow2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColUvaRow2Info, new RecordItemIndex(22));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColUvaRow2Info, "Text", "2020-1");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='40') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColCd1Row2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColCd1Row2Info, new RecordItemIndex(23));
            Validate.AttributeEqual(repo.B_BUAB_TblB.Tabelle_FlexGrid.ColCd1Row2Info, "Text", "40");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='200') on item 'B_BUAB_TblB.Tabelle_FlexGrid.ColCd3Row2'.", repo.B_BUAB_TblB.Tabelle_FlexGrid.ColCd3Row2Info, new RecordItemIndex(24));
