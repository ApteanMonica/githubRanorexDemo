...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("96ae1e07-2ade-40bc-bd5a-49e726ea5247", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='16.730,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow0'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, new RecordItemIndex(8));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, "Text", "16.730,00", null, false);
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='16.730,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow1'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, new RecordItemIndex(10));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, "Text", "16.730,00", null, false);
