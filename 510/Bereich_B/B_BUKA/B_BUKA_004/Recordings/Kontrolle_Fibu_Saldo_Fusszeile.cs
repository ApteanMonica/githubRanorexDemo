...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("a38a10f8-6d70-4da8-be87-2033850b6d7a", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='150,00') on item 'TblBuka.Fusszeile.ColAusgangRow0'.", repo.TblBuka.Fusszeile.ColAusgangRow0Info, new RecordItemIndex(7));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColAusgangRow0Info, "Text", "150,00", null, false);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(7)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='9.850,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow0'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, new RecordItemIndex(8));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, "Text", "9.850,00", null, false);
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='9.850,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow1'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, new RecordItemIndex(10));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, "Text", "9.850,00", null, false);
