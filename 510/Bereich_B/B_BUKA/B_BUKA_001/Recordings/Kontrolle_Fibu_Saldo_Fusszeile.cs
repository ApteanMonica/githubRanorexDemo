...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("312eddb5-42ec-4ae4-ae06-e20dac65c108", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='0,00') on item 'TblBuka.FlexGrid1.ColFibuSaldoRow1'.", repo.TblBuka.FlexGrid1.ColFibuSaldoRow1Info, new RecordItemIndex(3));
                Validate.AttributeEqual(repo.TblBuka.FlexGrid1.ColFibuSaldoRow1Info, "Text", "0,00", null, false);
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='10.000,00') on item 'TblBuka.Fusszeile.ColEingangRow0'.", repo.TblBuka.Fusszeile.ColEingangRow0Info, new RecordItemIndex(6));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColEingangRow0Info, "Text", "10.000,00", null, false);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(6)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='1.931,00') on item 'TblBuka.Fusszeile.ColAusgangRow0'.", repo.TblBuka.Fusszeile.ColAusgangRow0Info, new RecordItemIndex(7));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColAusgangRow0Info, "Text", "1.931,00", null, false);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(7)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='8.069,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow0'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, new RecordItemIndex(8));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, "Text", "8.069,00", null, false);
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='9.000,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow1'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, new RecordItemIndex(10));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, "Text", "9.000,00", null, false);
