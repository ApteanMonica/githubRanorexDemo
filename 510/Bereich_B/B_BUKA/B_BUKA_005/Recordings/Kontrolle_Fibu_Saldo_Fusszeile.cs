...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("ab4da042-aad3-4c00-acd5-63ab5b47dfca", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='7.250,00') on item 'TblBuka.Fusszeile.ColEingangRow0'.", repo.TblBuka.Fusszeile.ColEingangRow0Info, new RecordItemIndex(6));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColEingangRow0Info, "Text", "7.250,00", null, false);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(6)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='0,00') on item 'TblBuka.Fusszeile.ColAusgangRow0'.", repo.TblBuka.Fusszeile.ColAusgangRow0Info, new RecordItemIndex(7));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColAusgangRow0Info, "Text", "0,00", null, false);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(7)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='7.250,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow0'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, new RecordItemIndex(8));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow0Info, "Text", "7.250,00", null, false);
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (Text='7.250,00') on item 'TblBuka.Fusszeile.ColSaldoLfdRow1'.", repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, new RecordItemIndex(10));
                Validate.AttributeEqual(repo.TblBuka.Fusszeile.ColSaldoLfdRow1Info, "Text", "7.250,00", null, false);
