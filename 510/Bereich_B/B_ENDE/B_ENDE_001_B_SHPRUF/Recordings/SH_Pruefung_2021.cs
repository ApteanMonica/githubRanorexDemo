...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The SH_Pruefung_2021 recording.
    /// </summary>
    [TestModule("826c4055-7c4b-462d-9c70-132366548e65", ModuleType.Recording, 1)]
    public partial class SH_Pruefung_2021 : ITestModule
    {
        /// <summary>
        ...
        static SH_Pruefung_2021 instance = new SH_Pruefung_2021();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public SH_Pruefung_2021()
        {
        }
        ...
        /// </summary>
        public static SH_Pruefung_2021 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '2021' with focus on 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(0));
            repo.FrmMain.Jahr.PressKeys("2021");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(1));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2021') on item 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(2));
