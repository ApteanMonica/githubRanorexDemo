...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The SH_Pruefung_2022 recording.
    /// </summary>
    [TestModule("4497a20c-ffe9-4d08-8ddf-130ad176a385", ModuleType.Recording, 1)]
    public partial class SH_Pruefung_2022 : ITestModule
    {
        /// <summary>
        ...
        static SH_Pruefung_2022 instance = new SH_Pruefung_2022();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public SH_Pruefung_2022()
        {
        }
        ...
        /// </summary>
        public static SH_Pruefung_2022 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '2022' with focus on 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(0));
            repo.FrmMain.Jahr.PressKeys("2022");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(1));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2022') on item 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(2));
