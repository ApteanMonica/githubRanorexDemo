...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The SH_Pruefung_2019 recording.
    /// </summary>
    [TestModule("9ecc4441-7793-4c4b-8f65-488021bf2f96", ModuleType.Recording, 1)]
    public partial class SH_Pruefung_2019 : ITestModule
    {
        /// <summary>
        ...
        static SH_Pruefung_2019 instance = new SH_Pruefung_2019();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public SH_Pruefung_2019()
        {
        }
        ...
        /// </summary>
        public static SH_Pruefung_2019 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '2019' with focus on 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(0));
            repo.FrmMain.Jahr.PressKeys("2019");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(1));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2019') on item 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(2));
