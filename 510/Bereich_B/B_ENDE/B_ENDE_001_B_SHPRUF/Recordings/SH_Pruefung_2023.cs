...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The SH_Pruefung_2023 recording.
    /// </summary>
    [TestModule("3c292569-7a69-429c-ae9e-7c5528c27291", ModuleType.Recording, 1)]
    public partial class SH_Pruefung_2023 : ITestModule
    {
        /// <summary>
        ...
        static SH_Pruefung_2023 instance = new SH_Pruefung_2023();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public SH_Pruefung_2023()
        {
        }
        ...
        /// </summary>
        public static SH_Pruefung_2023 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '2023' with focus on 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(0));
            repo.FrmMain.Jahr.PressKeys("2023");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(1));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2023') on item 'FrmMain.Jahr'.", repo.FrmMain.JahrInfo, new RecordItemIndex(2));
