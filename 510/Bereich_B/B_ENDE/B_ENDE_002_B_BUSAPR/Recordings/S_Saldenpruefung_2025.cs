...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The S_Saldenpruefung_2025 recording.
    /// </summary>
    [TestModule("85a76e7a-5629-43b6-a5d7-051e54ee6ad0", ModuleType.Recording, 1)]
    public partial class S_Saldenpruefung_2025 : ITestModule
    {
        /// <summary>
        ...
        static S_Saldenpruefung_2025 instance = new S_Saldenpruefung_2025();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public S_Saldenpruefung_2025()
        {
        }
        ...
        /// </summary>
        public static S_Saldenpruefung_2025 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '2025' with focus on 'Form100PruefungSachkontenSalden.Jahr'.", repo.Form100PruefungSachkontenSalden.JahrInfo, new RecordItemIndex(0));
            repo.Form100PruefungSachkontenSalden.Jahr.PressKeys("2025");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(1));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2025') on item 'Form100PruefungSachkontenSalden.Jahr'.", repo.Form100PruefungSachkontenSalden.JahrInfo, new RecordItemIndex(2));
            Validate.AttributeEqual(repo.Form100PruefungSachkontenSalden.JahrInfo, "Text", "2025");
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2025') on item 'Form100PruefungSachkontenSalden.Jahr'.", repo.Form100PruefungSachkontenSalden.JahrInfo, new RecordItemIndex(12));
            Validate.AttributeEqual(repo.Form100PruefungSachkontenSalden.JahrInfo, "Text", "2025");
