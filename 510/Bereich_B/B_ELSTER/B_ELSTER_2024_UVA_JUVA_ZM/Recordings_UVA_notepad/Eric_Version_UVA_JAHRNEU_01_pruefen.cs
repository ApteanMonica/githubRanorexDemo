...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Eric_UVA_JAHRNEU_01_39_2) on item 'Editor_EricLog.Text15_Editor_ericlog'.", repo.Editor_EricLog.Text15_Editor_ericlogInfo, new RecordItemIndex(0));
            Validate.AttributeContains(repo.Editor_EricLog.Text15_Editor_ericlogInfo, "Text", Eric_UVA_JAHRNEU_01_39_2);
