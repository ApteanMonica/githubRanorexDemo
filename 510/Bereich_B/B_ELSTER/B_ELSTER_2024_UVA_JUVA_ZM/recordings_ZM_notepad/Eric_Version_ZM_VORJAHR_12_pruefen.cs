...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    public partial class Eric_Version_ZM_VORJAHR_12_pruefen : ITestModule
    {
        ...
        {
            Eric_ZM_VERSION_39_2 = "Datei: checkZMDO.dll,  Fileversion: 2023, 39, 2, 4, Produktversion: 39, 2, 4, 0";
        }
...
#region Variables
        ...
        string _Eric_ZM_VERSION_39_2;

        /// <summary>
        /// Gets or sets the value of variable Eric_ZM_VERSION_39_2.
        /// </summary>
        [TestVariable("ae2ec29f-047c-4d05-8461-4c88c61d70f5")]
        public string Eric_ZM_VERSION_39_2
        {
            get { return _Eric_ZM_VERSION_39_2; }
            set { _Eric_ZM_VERSION_39_2 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Eric_ZM_VERSION_39_2) on item 'Editor_EricLog.Text15_Editor_ericlog'.", repo.Editor_EricLog.Text15_Editor_ericlogInfo, new RecordItemIndex(0));
            Validate.AttributeContains(repo.Editor_EricLog.Text15_Editor_ericlogInfo, "Text", Eric_ZM_VERSION_39_2);
