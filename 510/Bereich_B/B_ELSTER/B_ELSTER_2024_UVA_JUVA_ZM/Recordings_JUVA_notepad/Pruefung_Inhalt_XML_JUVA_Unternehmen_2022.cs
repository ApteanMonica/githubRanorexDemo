...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeContains (Text>$XML_JUVA_2022_Unternehmen) on item 'XMLEditor_UVA_ZM5.Text15'.", repo.XMLEditor_UVA_ZM5.Text15Info, new RecordItemIndex(0));
                Validate.AttributeContains(repo.XMLEditor_UVA_ZM5.Text15Info, "Text", XML_JUVA_2022_Unternehmen, null, false);
