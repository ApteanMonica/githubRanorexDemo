...
#region Variables
        ...
        string _XML_JUVA_AnlageUN_Bank_2022;

        /// <summary>
        /// Gets or sets the value of variable XML_JUVA_AnlageUN_Bank_2022.
        /// </summary>
        [TestVariable("10974ca0-9301-4a89-a3e5-a00051eec9f3")]
        public string XML_JUVA_AnlageUN_Bank_2022
        {
            get { return _XML_JUVA_AnlageUN_Bank_2022; }
            set { _XML_JUVA_AnlageUN_Bank_2022 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeContains (Text>$XML_JUVA_AnlageUN_Bank_2022) on item 'Editor_XML_UVA_ZM.Text15_XML_Editor_UVA_ZM'.", repo.Editor_XML_UVA_ZM.Text15_XML_Editor_UVA_ZMInfo, new RecordItemIndex(0));
                Validate.AttributeContains(repo.Editor_XML_UVA_ZM.Text15_XML_Editor_UVA_ZMInfo, "Text", XML_JUVA_AnlageUN_Bank_2022, null, false);
