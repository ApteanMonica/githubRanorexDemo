...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5m to exist. Associated repository item: 'FrmMain_B_ZM.PbElster_visible_enabled'", repo.FrmMain_B_ZM.PbElster_visible_enabledInfo, new ActionTimeout(300000), new RecordItemIndex(0));
            repo.FrmMain_B_ZM.PbElster_visible_enabledInfo.WaitForExists(300000);
