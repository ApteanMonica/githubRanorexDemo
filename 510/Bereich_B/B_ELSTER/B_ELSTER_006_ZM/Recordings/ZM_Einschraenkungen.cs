...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("c4e56c2e-f820-4610-872f-f9701678506c", ModuleType.Recording, 1)]
    public partial class ZM_Einschraenkungen : ITestModule
    {
        /// <summary>
        ...
        static ZM_Einschraenkungen instance = new ZM_Einschraenkungen();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public ZM_Einschraenkungen()
        {
            Firma = "300";
            Jahr = "2023";
        }
        ...
        /// </summary>
        public static ZM_Einschraenkungen Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("2e87ddc1-8a96-4bcf-9d02-f7a003559d6c")]
        public string Firma
        {
            get { return _Firma; }
            set { _Firma = value; }
        ...
        /// </summary>
        [TestVariable("f044bc2a-0337-4330-bb5c-4b351e608849")]
        public string Jahr
        {
            get { return _Jahr; }
            set { _Jahr = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Jahr' with focus on 'FrmMain_B_ZM.ClientArea.Jahr'.", repo.FrmMain_B_ZM.ClientArea.JahrInfo, new RecordItemIndex(6));
            repo.FrmMain_B_ZM.ClientArea.Jahr.PressKeys(Jahr);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Jahr) on item 'FrmMain_B_ZM.ClientArea.Jahr'.", repo.FrmMain_B_ZM.ClientArea.JahrInfo, new RecordItemIndex(10));
            Validate.AttributeEqual(repo.FrmMain_B_ZM.ClientArea.JahrInfo, "Text", Jahr);
