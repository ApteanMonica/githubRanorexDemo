...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '499,99' with focus on 'MdiBuch.frmSB.colBube_betragRow1'.", repo.MdiBuch.frmSB.colBube_betragRow1Info, new RecordItemIndex(5));
            repo.MdiBuch.frmSB.colBube_betragRow1.PressKeys("499,99");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(6));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='499,99') on item 'MdiBuch.frmSB.colBube_betragRow1'.", repo.MdiBuch.frmSB.colBube_betragRow1Info, new RecordItemIndex(7));
            Validate.AttributeEqual(repo.MdiBuch.frmSB.colBube_betragRow1Info, "Text", "499,99");
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '30' with focus on 'MdiBuch.frmSB.ColBubeBektnr1Row1'.", repo.MdiBuch.frmSB.ColBubeBektnr1Row1Info, new RecordItemIndex(10));
            repo.MdiBuch.frmSB.ColBubeBektnr1Row1.PressKeys("30");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(11));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='KST 30') on item 'MdiBuch.frmSB.ColBezRow1'.", repo.MdiBuch.frmSB.ColBezRow1Info, new RecordItemIndex(12));
            Validate.AttributeEqual(repo.MdiBuch.frmSB.ColBezRow1Info, "Text", "KST 30");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(13));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='500,01') on item 'MdiBuch.frmSB.colBube_betragRow2'.", repo.MdiBuch.frmSB.colBube_betragRow2Info, new RecordItemIndex(14));
            Validate.AttributeEqual(repo.MdiBuch.frmSB.colBube_betragRow2Info, "Text", "500,01");
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '50' with focus on 'MdiBuch.frmSB.ColBubeBektnr1Row2'.", repo.MdiBuch.frmSB.ColBubeBektnr1Row2Info, new RecordItemIndex(18));
            repo.MdiBuch.frmSB.ColBubeBektnr1Row2.PressKeys("50");
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Tab' Press.", new RecordItemIndex(19));
            Keyboard.Press(System.Windows.Forms.Keys.Tab, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='KST 50') on item 'MdiBuch.frmSB.ColBezRow2'.", repo.MdiBuch.frmSB.ColBezRow2Info, new RecordItemIndex(20));
            Validate.AttributeEqual(repo.MdiBuch.frmSB.ColBezRow2Info, "Text", "KST 50");
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'MdiBuch.PbStandard2' at Center.", repo.MdiBuch.PbStandard2Info, new RecordItemIndex(21));
