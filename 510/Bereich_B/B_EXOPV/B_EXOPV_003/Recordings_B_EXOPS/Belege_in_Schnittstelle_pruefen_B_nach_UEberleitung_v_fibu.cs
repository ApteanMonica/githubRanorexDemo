...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Belege_in_Schnittstelle_pruefen_B_nach_UEberleitung_v_fibu recording.
    /// </summary>
    [TestModule("c150558c-ff75-42c1-8afb-15785852754b", ModuleType.Recording, 1)]
    public partial class Belege_in_Schnittstelle_pruefen_B_nach_UEberleitung_v_fibu : ITestModule
    {
        /// <summary>
        ...
        static Belege_in_Schnittstelle_pruefen_B_nach_UEberleitung_v_fibu instance = new Belege_in_Schnittstelle_pruefen_B_nach_UEberleitung_v_fibu();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Belege_in_Schnittstelle_pruefen_B_nach_UEberleitung_v_fibu()
        {
            Beleg1 = "R20/0009";
            Beleg2 = "R20/0010";
            Tagesdatum = "";
        ...
        /// </summary>
        public static Belege_in_Schnittstelle_pruefen_B_nach_UEberleitung_v_fibu Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_1.ColExopDtherkunftRow1Info, "Text", Tagesdatum);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Tagesdatum) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_1.ColExopDtanlagRow1'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_1.ColExopDtanlagRow1Info, new RecordItemIndex(7));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_1.ColExopDtanlagRow1Info, "Text", Tagesdatum);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Tagesdatum) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_1.ColExopDtaendgRow1'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_1.ColExopDtaendgRow1Info, new RecordItemIndex(8));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='N') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopStatusRow2'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopStatusRow2Info, new RecordItemIndex(10));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Tagesdatum) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtherkunftRow2'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtherkunftRow2Info, new RecordItemIndex(15));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtherkunftRow2Info, "Text", Tagesdatum);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Tagesdatum) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtanlagRow2'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtanlagRow2Info, new RecordItemIndex(16));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtanlagRow2Info, "Text", Tagesdatum);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Tagesdatum) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtaendgRow2'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtaendgRow2Info, new RecordItemIndex(17));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_2.ColExopDtaendgRow2Info, "Text", Tagesdatum);
            
            // Zeile_3
            Report.Log(ReportLevel.Info, "Section", "Zeile_3", new RecordItemIndex(18));
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='N') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_3.ColExopStatusRow3'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_3.ColExopStatusRow3Info, new RecordItemIndex(19));
            ...
            Report.Log(ReportLevel.Info, "Section", "Zeile_4 auf Status S geändert", new RecordItemIndex(27));
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='S') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopStatusRow4'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopStatusRow4Info, new RecordItemIndex(28));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>'03.02.2020') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtherkunftRow4'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtherkunftRow4Info, new RecordItemIndex(33));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtherkunftRow4Info, "Text", "03.02.2020");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>'03.02.2020') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtanlagRow4'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtanlagRow4Info, new RecordItemIndex(34));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtanlagRow4Info, "Text", "03.02.2020");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Tagesdatum) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtaendgRow4'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_4.ColExopDtaendgRow4Info, new RecordItemIndex(35));
            ...
            Report.Log(ReportLevel.Info, "Section", "Zeile_5 Status V (unverändert)", new RecordItemIndex(36));
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='V') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopStatusRow5'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopStatusRow5Info, new RecordItemIndex(37));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Beleg2) on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopBelegnrRow5'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopBelegnrRow5Info, new RecordItemIndex(38));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='1.200,00') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopBetragRow5'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopBetragRow5Info, new RecordItemIndex(39));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>'03.02.2020') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtherkunftRow5'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtherkunftRow5Info, new RecordItemIndex(42));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtherkunftRow5Info, "Text", "03.02.2020");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>'03.02.2020') on item 'FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtanlagRow5'.", repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtanlagRow5Info, new RecordItemIndex(43));
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtanlagRow5Info, "Text", "03.02.2020");
            ...
            Validate.AttributeContains(repo.FrmBEXOP_Verwalten_Schnittstelle.FlexGrid_EXOP_Belege_fixe_Zeilennr.Row_5.ColExopDtaendgRow5Info, "Text", "03.02.2020");
