...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>$Protokolldatei_B_Datei) on item 'FehlerprotokollBExopv_TxtEditor.Fehlerprotokoll_TxtEditor'.", repo.FehlerprotokollBExopv_TxtEditor.Fehlerprotokoll_TxtEditorInfo, new RecordItemIndex(1));
            Validate.AttributeContains(repo.FehlerprotokollBExopv_TxtEditor.Fehlerprotokoll_TxtEditorInfo, "Text", Protokolldatei_B_Datei);
            ...
            //Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (Text>'[100] Starte Verbuchung RS\\2-Lager') on item 'FehlerprotokollBExopv_TxtEditor.Text15'.", repo.FehlerprotokollBExopv_TxtEditor.Text15Info, new RecordItemIndex(15));
