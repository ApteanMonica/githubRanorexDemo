...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("d7e74715-c9c0-4d11-a9bf-d5d4bc6fb0eb", ModuleType.Recording, 1)]
...
#region Variables
        ...
        /// </summary>
        [TestVariable("e22b7b28-0c95-4819-b224-53ecd2c63c3f")]
        public string Jahr
        {
            get { return _Jahr; }
            set { _Jahr = value; }
        ...
        /// </summary>
        [TestVariable("ab5c8e2f-c466-430a-8593-c2eaccb03736")]
        public string Monat
        {
            get { return _Monat; }
            set { _Monat = value; }
        ...
        /// </summary>
        [TestVariable("ae422218-7273-4453-b0d9-45f21d0467a4")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblB.CDCCTools_Einschraenkungen.Buchgdatum' at Center.", repo.TblB.CDCCTools_Einschraenkungen.BuchgdatumInfo, new RecordItemIndex(12));
            repo.TblB.CDCCTools_Einschraenkungen.Buchgdatum.Click();
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Tagesdatum' with focus on 'TblB.CDCCTools_Einschraenkungen.Buchgdatum'.", repo.TblB.CDCCTools_Einschraenkungen.BuchgdatumInfo, new RecordItemIndex(13));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblB.CDCCTools_Einschraenkungen.Benutzer' at Center.", repo.TblB.CDCCTools_Einschraenkungen.BenutzerInfo, new RecordItemIndex(15));
            repo.TblB.CDCCTools_Einschraenkungen.Benutzer.Click();
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'EXTERN' with focus on 'TblB.CDCCTools_Einschraenkungen.Benutzer'.", repo.TblB.CDCCTools_Einschraenkungen.BenutzerInfo, new RecordItemIndex(16));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'TblB.PbDataAccessLoad' at Center.", repo.TblB.PbDataAccessLoadInfo, new RecordItemIndex(18));
            repo.TblB.PbDataAccessLoad.Click();
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 2m to exist. Associated repository item: 'TblB.Buchungszeilen_Tabelle.Zeile_8.Row8'", repo.TblB.Buchungszeilen_Tabelle.Zeile_8.Row8Info, new ActionTimeout(120000), new RecordItemIndex(19));
            repo.TblB.Buchungszeilen_Tabelle.Zeile_8.Row8Info.WaitForExists(120000);
