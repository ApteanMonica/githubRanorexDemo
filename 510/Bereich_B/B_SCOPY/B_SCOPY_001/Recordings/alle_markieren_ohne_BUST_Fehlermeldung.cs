...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The alle_markieren_ohne_BUST_Fehlermeldung recording.
    /// </summary>
    [TestModule("c97f1237-7055-41c0-b36d-d2731ada03a0", ModuleType.Recording, 1)]
    public partial class Alle_markieren_ohne_BUST_Fehlermeldung : ITestModule
    {
        /// <summary>
        ...
        static Alle_markieren_ohne_BUST_Fehlermeldung instance = new Alle_markieren_ohne_BUST_Fehlermeldung();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Alle_markieren_ohne_BUST_Fehlermeldung()
        {
        }
        ...
        /// </summary>
        public static Alle_markieren_ohne_BUST_Fehlermeldung Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'FrmBSCOPY.PbAlleA' at Center.", repo.FrmBSCOPY.PbAlleAInfo, new RecordItemIndex(0));
            repo.FrmBSCOPY.PbAlleA.Click();
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Checked='False') on item 'FrmBSCOPY.Frame2_10_Checkboxen_Datenauswahl.CbBst1_BUST_K'.", repo.FrmBSCOPY.Frame2_10_Checkboxen_Datenauswahl.CbBst1_BUST_KInfo, new RecordItemIndex(1));
            Validate.AttributeEqual(repo.FrmBSCOPY.Frame2_10_Checkboxen_Datenauswahl.CbBst1_BUST_KInfo, "Checked", "False");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Checked='True') on item 'FrmBSCOPY.Frame2_10_Checkboxen_Datenauswahl.CbUSt2_UST_A'.", repo.FrmBSCOPY.Frame2_10_Checkboxen_Datenauswahl.CbUSt2_UST_AInfo, new RecordItemIndex(2));
            Validate.AttributeEqual(repo.FrmBSCOPY.Frame2_10_Checkboxen_Datenauswahl.CbUSt2_UST_AInfo, "Checked", "True");
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Ustkonten: keine Geschäftsjahr-Daten für Firma 250 vorhanden.\r\n') on item 'DlgMessageBox.LabelMeldungstext'.", repo.DlgMessageBox.LabelMeldungstextInfo, new RecordItemIndex(7));
            Validate.AttributeEqual(repo.DlgMessageBox.LabelMeldungstextInfo, "Text", "Ustkonten: keine Geschäftsjahr-Daten für Firma 250 vorhanden.\r\n");
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='Es ist ein Fehler aufgetreten!') on item 'DlgMessageBox.LabelMeldungstext'.", repo.DlgMessageBox.LabelMeldungstextInfo, new RecordItemIndex(11));
