...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("be48613d-1ddd-477a-abee-fc582542b658", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmBSCOPY.TitleBar200KopierenStammdaten'.", repo.FrmBSCOPY.TitleBar200KopierenStammdatenInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.FrmBSCOPY.TitleBar200KopierenStammdaten, 1000);
