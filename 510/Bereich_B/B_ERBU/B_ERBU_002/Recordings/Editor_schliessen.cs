...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("efa8e223-7537-499b-96b6-2114bb6e820d", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'ExoperrTxtEditor.ExoperrTxtEditor'.", repo.ExoperrTxtEditor.ExoperrTxtEditorInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.ExoperrTxtEditor.ExoperrTxtEditor, 1000);
