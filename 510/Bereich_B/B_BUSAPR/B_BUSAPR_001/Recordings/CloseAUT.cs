...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("973f0cae-a5e7-4450-be9d-a3829703705b", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmMain.TitleBar100PruefungSachkontenSalden'.", repo.FrmMain.TitleBar100PruefungSachkontenSaldenInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.FrmMain.TitleBar100PruefungSachkontenSalden, 1000);
