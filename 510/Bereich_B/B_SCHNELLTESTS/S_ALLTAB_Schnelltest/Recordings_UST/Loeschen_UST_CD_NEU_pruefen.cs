...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating NotExists on item 'TblUstVerwalten.Row_mit_UST_CD_NEU.row'.", repo.TblUstVerwalten.Row_mit_UST_CD_NEU.rowInfo, new RecordItemIndex(3));
