...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("dd6ae71b-6911-4f90-81d0-e6e7c8342524", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TblZahlungsarten.TitleBar100Zahlungsarten'.", repo.TblZahlungsarten.TitleBar100ZahlungsartenInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TblZahlungsarten.TitleBar100Zahlungsarten, 1000);
