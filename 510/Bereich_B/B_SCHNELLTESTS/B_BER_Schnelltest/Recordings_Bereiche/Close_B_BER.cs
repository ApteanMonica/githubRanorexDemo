...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("dd0e6cd7-5a99-4ccf-aba8-3bd917f544ba", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TblBer.TitleBar100VerwaltenBereiche'.", repo.TblBer.TitleBar100VerwaltenBereicheInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TblBer.TitleBar100VerwaltenBereiche, 1000);
