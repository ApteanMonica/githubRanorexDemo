...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("421f4a66-ec5b-40c8-9024-a3d06f7f89bf", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmBank.TitleBar100VerwaltungBankverbindung'.", repo.FrmBank.TitleBar100VerwaltungBankverbindungInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.FrmBank.TitleBar100VerwaltungBankverbindung, 1000);
