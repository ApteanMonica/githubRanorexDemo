...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "TODO: variabel Zeile mit A21 selektieren\r\nValidating AttributeEqual (Text=$Form_Name_VORJAHR) on item 'TblUVAF.FlexGrid.UVA_Form_Bez_in_Zeile_mit_Form_Name_VORJAHR'.", repo.TblUVAF.FlexGrid.UVA_Form_Bez_in_Zeile_mit_Form_Name_VORJAHRInfo, new RecordItemIndex(2));
            Validate.AttributeEqual(repo.TblUVAF.FlexGrid.UVA_Form_Bez_in_Zeile_mit_Form_Name_VORJAHRInfo, "Text", Form_Name_VORJAHR);
            
            // TODO: variabel Zeile mit A21_ selektieren
            Report.Log(ReportLevel.Info, "Validation", "TODO: variabel Zeile mit A21_ selektieren\r\nValidating AttributeEqual (AccessibleValue='True') on item 'TblUVAF.FlexGrid.ColUvaDrucken_Zeile_mit_Form_Name_VORJAHR'.", repo.TblUVAF.FlexGrid.ColUvaDrucken_Zeile_mit_Form_Name_VORJAHRInfo, new RecordItemIndex(3));
            Validate.AttributeEqual(repo.TblUVAF.FlexGrid.ColUvaDrucken_Zeile_mit_Form_Name_VORJAHRInfo, "AccessibleValue", "True");
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left DoubleClick item 'TblUVAF.FlexGrid.UVA_Form_Bez_in_Zeile_mit_Form_Name_VORJAHR' at Center.", repo.TblUVAF.FlexGrid.UVA_Form_Bez_in_Zeile_mit_Form_Name_VORJAHRInfo, new RecordItemIndex(4));
            repo.TblUVAF.FlexGrid.UVA_Form_Bez_in_Zeile_mit_Form_Name_VORJAHR.DoubleClick();
