...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("2afa131c-5303-4a53-bdb1-31d6453924be", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'FrmLagerbuch.TitleBar100Lagerbuchungen'.", repo.FrmLagerbuch.TitleBar100LagerbuchungenInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.FrmLagerbuch.TitleBar100Lagerbuchungen, 1000);
