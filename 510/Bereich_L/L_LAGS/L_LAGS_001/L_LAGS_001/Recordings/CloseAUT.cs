...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("3cf2aa5e-f6ac-47f5-9cba-d6293afc2cfa", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'MdiLag.TitleBar100VerwaltungLager'.", repo.MdiLag.TitleBar100VerwaltungLagerInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.MdiLag.TitleBar100VerwaltungLager, 1000);
