...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$Periode_bis' with focus on 'TblIbufe.Einchraenkungen.TextBis_530_510'.", repo.TblIbufe.Einchraenkungen.TextBis_530_510Info, new RecordItemIndex(7));
            repo.TblIbufe.Einchraenkungen.TextBis_530_510.PressKeys(Periode_bis);
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text=$Periode_bis) on item 'TblIbufe.Einchraenkungen.TextBis_530_510'.", repo.TblIbufe.Einchraenkungen.TextBis_530_510Info, new RecordItemIndex(12));
            Validate.AttributeEqual(repo.TblIbufe.Einchraenkungen.TextBis_530_510Info, "Text", Periode_bis);
