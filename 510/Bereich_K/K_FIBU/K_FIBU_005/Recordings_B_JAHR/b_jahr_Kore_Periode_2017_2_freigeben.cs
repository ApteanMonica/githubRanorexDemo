...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("3f670609-3118-40a5-8387-d362b7ab1ecd", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '2' on item 'FrmMain.SomeText'.", repo.FrmMain.SomeTextInfo, new RecordItemIndex(2));
            repo.FrmMain.SomeText.Element.SetAttributeValue("Text", "2");
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '2' on item 'FrmMain.SomeText'.", repo.FrmMain.SomeTextInfo, new RecordItemIndex(5));
            repo.FrmMain.SomeText.Element.SetAttributeValue("Text", "2");
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2') on item 'FrmMain.Tabelle.ColGjhrPerivonKore_Zeile_GJ_2017'.", repo.FrmMain.Tabelle.ColGjhrPerivonKore_Zeile_GJ_2017Info, new RecordItemIndex(8));
            Validate.AttributeEqual(repo.FrmMain.Tabelle.ColGjhrPerivonKore_Zeile_GJ_2017Info, "Text", "2");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='2') on item 'FrmMain.Tabelle.ColGjhrPeribisKore_Zeile_GJ_2017'.", repo.FrmMain.Tabelle.ColGjhrPeribisKore_Zeile_GJ_2017Info, new RecordItemIndex(9));
            Validate.AttributeEqual(repo.FrmMain.Tabelle.ColGjhrPeribisKore_Zeile_GJ_2017Info, "Text", "2");
