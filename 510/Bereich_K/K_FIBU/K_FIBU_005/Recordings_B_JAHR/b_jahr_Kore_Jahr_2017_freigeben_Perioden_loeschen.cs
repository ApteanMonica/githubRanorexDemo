...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '' on item 'FrmMain.SomeText'.", repo.FrmMain.SomeTextInfo, new RecordItemIndex(2));
            repo.FrmMain.SomeText.Element.SetAttributeValue("Text", "");
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Text to '' on item 'FrmMain.SomeText'.", repo.FrmMain.SomeTextInfo, new RecordItemIndex(5));
            repo.FrmMain.SomeText.Element.SetAttributeValue("Text", "");
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='') on item 'FrmMain.Tabelle.ColGjhrPerivonKore_Zeile_GJ_2017'.", repo.FrmMain.Tabelle.ColGjhrPerivonKore_Zeile_GJ_2017Info, new RecordItemIndex(8));
            Validate.AttributeEqual(repo.FrmMain.Tabelle.ColGjhrPerivonKore_Zeile_GJ_2017Info, "Text", "");
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Text='') on item 'FrmMain.Tabelle.ColGjhrPeribisKore_Zeile_GJ_2017'.", repo.FrmMain.Tabelle.ColGjhrPeribisKore_Zeile_GJ_2017Info, new RecordItemIndex(9));
            Validate.AttributeEqual(repo.FrmMain.Tabelle.ColGjhrPeribisKore_Zeile_GJ_2017Info, "Text", "");
