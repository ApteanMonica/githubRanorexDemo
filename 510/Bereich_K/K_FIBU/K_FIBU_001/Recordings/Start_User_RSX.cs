...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Start_User_RSX recording.
    /// </summary>
    [TestModule("f96d9493-d4a6-4858-8a66-e45393d1f7b9", ModuleType.Recording, 1)]
    public partial class Start_User_RSX : ITestModule
    {
        /// <summary>
        ...
        static Start_User_RSX instance = new Start_User_RSX();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Start_User_RSX()
        {
            Startfile = "C:\\Testdaten\\Allgemein\\Start.bat";
            K_FIBU_USER_RSX = "K_FIBU x x RSX";
        }

        /// <summary>
        /// Gets a static instance of this recording.
        /// </summary>
        public static Start_User_RSX Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("9cd01264-8739-4fba-aff7-b7f3ce9678eb")]
        ...
        string _K_FIBU_USER_RSX;

        /// <summary>
        /// Gets or sets the value of variable K_FIBU_USER_RSX.
        /// </summary>
        [TestVariable("32304562-38d2-4d52-bbdf-228996858f1a")]
        public string K_FIBU_USER_RSX
        {
            get { return _K_FIBU_USER_RSX; }
            set { _K_FIBU_USER_RSX = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Run application with file name from variable $Startfile with arguments from variable $K_FIBU_USER_RSX in normal mode.", new RecordItemIndex(0));
            Host.Local.RunApplication(Startfile, K_FIBU_USER_RSX, "", false);
