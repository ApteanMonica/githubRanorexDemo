...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'MdiMain.TitleBar100Verrechnungsstamm'.", repo.MdiMain.TitleBar100VerrechnungsstammInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.MdiMain.TitleBar100Verrechnungsstamm, 1000);
