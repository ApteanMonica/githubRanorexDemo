...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 1m to exist. Associated repository item: 'TblVerr_K_VERE.Row3_zweite_Erfassungszeile.Row3_zweite_Erfassungszeile'", repo.TblVerr_K_VERE.Row3_zweite_Erfassungszeile.Row3_zweite_ErfassungszeileInfo, new ActionTimeout(60000), new RecordItemIndex(2));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='False') on item 'TblVerr_K_VERE.Row2_erste_Erfassungszeile.ColKs1NrVonRow2'.", repo.TblVerr_K_VERE.Row2_erste_Erfassungszeile.ColKs1NrVonRow2Info, new RecordItemIndex(4));
