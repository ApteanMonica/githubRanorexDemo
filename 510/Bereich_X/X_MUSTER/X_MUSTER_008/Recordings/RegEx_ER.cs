...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RegEx_ER recording.
    /// </summary>
    [TestModule("36aab6cd-9ab6-4478-aee7-43588bec4ffd", ModuleType.Recording, 1)]
    public partial class RegEx_ER : ITestModule
    {
        /// <summary>
        ...
        static RegEx_ER instance = new RegEx_ER();
        ...
        /// </summary>
        public static RegEx_ER Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("045e7dea-b715-4181-9b67-368352aa4f2a")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeRegex (Text~'ER_?(.)+[\\d]+') on item 'TblB.ColBelegnrRow1'.", repo.TblB.ColBelegnrRow1Info, new RecordItemIndex(2));
            Validate.AttributeRegex(repo.TblB.ColBelegnrRow1Info, "Text", new Regex("ER_?(.)+[\\d]+"));
