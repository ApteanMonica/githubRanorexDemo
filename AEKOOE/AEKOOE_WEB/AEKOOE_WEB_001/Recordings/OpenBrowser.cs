...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (InnerText>'Anmeld') on item 'Login.RS2WEBAnmelden'.", repo.Login.RS2WEBAnmeldenInfo, new RecordItemIndex(2));
            Validate.AttributeContains(repo.Login.RS2WEBAnmeldenInfo, "InnerText", "Anmeld");
